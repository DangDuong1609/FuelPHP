                ...
                <form class="col-4" action="" method="post">
                    ...
                    <div class="form-outline mb-4">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="floatingInputGrid" placeholder="Username/Email" value="" name="usernameoremail">
                    ...
                    <div class="form-outline mb-4">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="floatingInputGrid" placeholder="Password" value="" name="password">
                    ...
                    <input type = "submit" class="btn btn-outline-primary" value = "Sign in"/><br />
